...
| 数据库迁移 | Flyway，手动 `FlywayConfig` 执行（V1–V94，共 93 个脚本） |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 5.0 | 2026-07-13 | Flyway 迁移版本补充至 V94（新增 V85–V94）；新增 BPMN 2.0 流程引擎解析模块（extractors/bpmn + BpmnFileAdapter/BpmnEngineDbAdapter）；NodeType/EdgeType 枚举新增 BPMN 相关类型；前端页面补充至 64 个 |
